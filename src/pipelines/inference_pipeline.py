...
def run_batch_inference(
    ...
    MLflow Model Registry에서 통합 모델(PyfuncWrapper)을 로드하여 추론을 수행합니다.

    Args:
        settings: 프로젝트 설정 객체.
        model_uri: 사용할 모델의 MLflow Model URI (e.g., "models:/<name>/<version>").
    ...
    try:
        ...
        # PyfuncWrapper는 예측 결과를 DataFrame으로 반환
        ...
        # loader 설정의 첫 번째 키를 대표 로더로 간주하고 dataset_id를 가져옴
