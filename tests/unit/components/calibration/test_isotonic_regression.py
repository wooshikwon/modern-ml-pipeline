...
class TestIsotonicCalibration:
    ...
    def setup_method(self):
        ...
        X_multi, y_multi = make_classification(
            ...
            n_informative=10, n_redundant=0, n_clusters_per_class=1,
            random_state=42
        )
    ...
    def test_fit_with_binary_data_but_multiclass_labels_raises_error(self):
        ...
        with pytest.raises(ValueError, match="이진 확률값\\(1D\\)이지만 3개 클래스가 발견되었습니다"):
    ...
    def test_transform_wrong_number_of_classes_raises_error(self):
        ...
        with pytest.raises(ValueError, match="확률 행렬의 클래스 수\\(2\\)와 학습된 클래스 수\\(3\\)가 다릅니다"):
