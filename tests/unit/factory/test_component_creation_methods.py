...
class TestFactoryEvaluatorCreation:
    ...
    def test_create_regression_evaluator(self, settings_builder, small_real_models_cache):
        ...
        regression_metrics = ["mse", "mae", "r2", "mean_squared_error", "mean_absolute_error", "r2_score"]
...
class TestFactoryPyfuncWrapperCreation:
    ...
    def test_create_pyfunc_wrapper_with_minimal_components(self, settings_builder, small_real_models_cache):
        ...
        assert pyfunc_wrapper.trained_datahandler is None  # Intentionally None for MLflow serialization
    
    def test_create_pyfunc_wrapper_with_all_components(self, settings_builder, small_real_models_cache):
        ...
        assert pyfunc_wrapper.trained_datahandler is None  # Intentionally None for serialization
        assert pyfunc_wrapper.trained_preprocessor is None  # Intentionally None for serialization
        assert pyfunc_wrapper.trained_fetcher is None  # Intentionally None for serialization
