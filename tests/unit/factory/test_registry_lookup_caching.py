...
class TestRegistryLookupMechanisms:
    ...
    def test_adapter_registry_lookup_methods(self, settings_builder):
        ...
        # Test list_adapters() method - returns Dict[str, Type[BaseAdapter]]
        available_adapters = AdapterRegistry.list_adapters()
        assert isinstance(available_adapters, dict)
    ...
    def test_evaluator_registry_task_based_lookup(self, settings_builder):
        ...
        # Test get_available_tasks() method
        available_tasks = EvaluatorRegistry.get_available_tasks()
        ...
        # Test get_evaluator_class() method
        cls_evaluator_class = EvaluatorRegistry.get_evaluator_class("classification")
        reg_evaluator_class = EvaluatorRegistry.get_evaluator_class("regression")
...
class TestFactoryComponentCaching:
    ...
    def test_component_caching_same_type_same_instance(self, settings_builder, performance_benchmark):
...
class TestRegistryCacheInteraction:
    ...
    def test_multiple_factories_share_registry_but_separate_caches(self, settings_builder):
        ...
        settings1 = settings_builder \
            .with_task("classification") \
            .with_model("sklearn.ensemble.RandomForestClassifier") \
            .build()
        
        settings2 = settings_builder \
...
class TestRegistryPerformanceBenchmarks:
    ...
    def test_registry_lookup_and_caching_performance(self, settings_builder, performance_benchmark):
        ...
        performance_benchmark.assert_time_under("registry_lookup", 0.02)  # 20ms for registry operations
        performance_benchmark.assert_time_under("factory_creation_cache_miss", 0.2)  # 200ms for creation
        performance_benchmark.assert_time_under("factory_creation_cache_hit", 0.01)  # 10ms for cache hits
        ...
        assert hit_time < miss_time * 0.8  # Cache hits should be at least 20% faster
...
class TestAdvancedCachingScenarios:
    ...
    def test_cache_key_generation_and_isolation(self, settings_builder, isolated_temp_directory):
        ...
        settings_storage = settings_builder \
            .with_data_source("storage") \
            .with_task("classification") \
            .build()
