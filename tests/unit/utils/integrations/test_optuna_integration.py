...
class TestOptunaRequirement:
    ...
    @patch('src.utils.integrations.optuna_integration.optuna', side_effect=ImportError)
    def test_require_optuna_missing_package(self, mock_optuna):
...
class TestOptunaHyperparameterSuggestion:
    ...
    @patch('src.utils.integrations.optuna_integration._require_optuna')
    def test_suggest_hyperparameters_categorical_type(self, mock_require_optuna, component_test_context):
    ...
    @patch('src.utils.integrations.optuna_integration._require_optuna')
    def test_suggest_hyperparameters_unknown_type(self, mock_require_optuna, component_test_context):
        ...
        with component_test_context.classification_stack() as ctx:
            ...
            assert result['unknown_type_param'] == {
                'type': 'unknown_type',
                'value': 'some_value'
            }

    @patch('src.utils.integrations.optuna_integration._require_optuna')
    def test_suggest_hyperparameters_mixed_params(self, mock_require_optuna, component_test_context):
...
class TestOptunaIntegrationIntegration:
    ...
    @patch('src.utils.integrations.optuna_integration._require_optuna')
    def test_complete_hyperparameter_tuning_workflow(self, mock_require_optuna, component_test_context):
