...
"""
    ...
    def test_pipeline_layer_error_propagation_and_recovery(self, isolated_temp_directory, settings_builder, make_fail_fast_mlflow):
        ...
        try:
            ...
            fast_mlflow_settings = settings_builder \
                .with_task("classification") \
                .with_model("sklearn.ensemble.RandomForestClassifier") \
                .with_mlflow(tracking_uri=f"file://{isolated_temp_directory}/mlruns", experiment_name="test_error_recovery_infer") \
                .build()
